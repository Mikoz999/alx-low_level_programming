...
/**
 * check97 - Checks for the exact number of argument needed.
...
/**
 * check100 - Ensures that all file descriptors were closed
 *properly
...
/**
 * main - A function that copies the content of a
